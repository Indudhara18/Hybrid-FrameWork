...
{
	// Declare the WebElements present in TaskList Page
	...
	//div[@class='title']/ancestor::div[@class='node customerNode notSelected']
	@FindBy( xpath = "//a[@class='x-menu-item']" )		// ElementClickInterceptedException Solved
	...
	//li[@class='x-menu-list-item ' and contains(@id,'ext-gen') ]/..)[2]/li
	...
	public void setTaskName(ArrayList<String> al) 
	{
		Random r = new Random() ;
		int randamNUM = r.nextInt(10000);
		
		int index = 0 ;
		for (WebElement taskTB : entertaskname) 
		{	
			taskTB.sendKeys(al.get(index) + "" + randamNUM);
			index++ ;
		}
	}
